...
export const Items = [
  ...
  },
  {
    id: 6,
    category: 'accessory',
    productName: 'Boult AirBass Propods TWS',
    productPrice: 1299,
    description:
...

  {
    id: 7,
    category: 'treding',
    productName: 'Lenovo Ideapad 3 15IAU7 i3',
    productPrice: 1799,
    description:
      'Up to 20 hours battery life | Super powerful Bass | 40mm dynamic driver | Pressure less ear muffs | Bluetooth 5.0 | Voice control',
    isOff: true,
    offPercentage: 10,
    productImage: require('../database/images/treding/laptop2.jpg'),
    isAvailable: true,
    productImageList: [
      require('../database/images/treding/lp1.jpg'),
      require('../database/images/treding/lp2.jpg'),
      require('../database/images/treding/lp3.jpg'),
    ],
  },
  {
    id: 8,
    category: 'treding',
    productName: 'Dell Vostro 3510 i5 1135G7',
    productPrice: 1499,
    description:
      'boAt Rockerz 450 M is an on-ear wireless headset that has been ergonomically designed to meet the needs of music lovers.',
    isOff: false,
    productImage: require('../database/images/treding/laptop1.jpg'),
    isAvailable: true,
    productImageList: [
      require('../database/images/treding/lp1.jpg'),
      require('../database/images/treding/lp2.jpg'),
  ...
  },
  {
    ...
    isOff: true,
    offPercentage: 10,
    productImage: require('../database/images/treding/laptop3.jpg'),
    isAvailable: true,
    productImageList: [
      require('../database/images/treding/lp1.jpg'),
      require('../database/images/treding/lp2.jpg'),
  ...
  },
  {
    id: 10,
    category: 'treding',
    productName: 'Acer TravelMate B3 TMB311',
    productPrice: 1499,
    description:
      'boAt Rockerz 450 M is an on-ear wireless headset that has been ergonomically designed to meet the needs of music lovers.',
    isOff: false,
    productImage: require('../database/images/treding/laptop4.jpg'),
    isAvailable: true,
    productImageList: [
      require('../database/images/treding/lp1.jpg'),
      require('../database/images/treding/lp2.jpg'),
